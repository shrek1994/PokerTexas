...
public class FullHouseCheckerTest {
    ...
    private Card secondCard = new Card(Figure.Eight, Color.Spades);
    private Card thirdCard = new Card(Figure.Eight, Color.Hearts);
    ...
    public void setUp() throws Exception {
        ...
        sut = new FullHouseChecker(cardChecker);
    }
    ...
    @Test
    public void shouldCorrectFindOnePairAndHighestCard()
    {
        ConfigurationCard expected = new ConfigurationCard(SetOfCard.FullHouse, highestCard);
    ...
    @Test
    public void shouldNotFindOnePairAndCallNextChecker()
    {
