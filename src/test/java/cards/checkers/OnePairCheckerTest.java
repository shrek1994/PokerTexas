...
public class OnePairCheckerTest {
    //TODO powinno zwracac pare jako najwyzsza karta
    ...
    public void setUp() throws Exception {
        ...
        sut = new OnePairChecker(cardChecker);
    }
    ...
    {
        ConfigurationCard expected = new ConfigurationCard(SetOfCard.OnePair, highestCard);
