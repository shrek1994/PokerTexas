...
public class TwoPairCheckerTest {
    ...
    public void setUp() throws Exception {
        ...
        sut = new TwoPairChecker(cardChecker);
    }
    ...
    @Test
    public void shouldCorrectFindTwoPairAndHighestCard()
    {
        ConfigurationCard expected = new ConfigurationCard(SetOfCard.TwoPair, highestCard);
    ...
    @Test
    public void shouldNotFindTwoPairAndCallNextChecker()
    {
