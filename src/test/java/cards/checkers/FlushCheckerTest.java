...
public class FlushCheckerTest {
    //TODO powinno zwracac w tym kolorze najwyzsza karte
    private Card highestCard = new Card(Figure.King, Color.Diamonds);
    private Card firstCard = new Card(Figure.Eight, Color.Diamonds);
    ...
    public void setUp() throws Exception {
        ...
        sut = new FlushChecker(cardChecker);
    }
    ...
    @Test
    public void shouldCorrectFindFlushAndHighestCard()
    {
        ConfigurationCard expected = new ConfigurationCard(SetOfCard.Flush, highestCard);
    ...
    @Test
    public void shouldNotFindFlushAndCallNextChecker()
    {
